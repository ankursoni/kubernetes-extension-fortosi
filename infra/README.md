...
sed -i 's|<VM_SIZE>|PLACEHOLDER|g' azurerm-secret.tfvars
...
sed -i 's|<VM_COUNT>|PLACEHOLDER|g' azurerm-secret.tfvars
...
```
cd infra
terraform destroy -var-file=azurerm-secret.tfvars
```